<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            Create {{ intval(\Illuminate\Support\Facades\Auth::user()->type) == USER_TYPE_ADMIN ? 'User' : 'Student' }}
        </h2>
    </x-slot>
                ...
                <form action="{{ route('users.store') }}" method="POST">
                    ...
                    @if(intval(\Illuminate\Support\Facades\Auth::user()->type) == USER_TYPE_ADMIN)
                        <div class="form-control w-full">
                            ...
                            <div class="flex">
                                ...
                                <input class="mt-1 mr-1" type="radio" name="type"
                                       @if(old('type') == USER_TYPE_STUDENT) checked @endif
                    ...
                    <div class="mt-5">
                        ...
                        <button class="btn btn-primary">
                            Add {{ intval(\Illuminate\Support\Facades\Auth::user()->type) == USER_TYPE_ADMIN ? 'User' : 'Student' }}</button>
                    </div>
                </form>
